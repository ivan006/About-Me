    ...
    slimScroll: function(h) {
      ...
      this.each(function() {
        ...
        function m(d, f, h) {
          ...
          f &&
            ((e = parseInt(c.css("top")) + ((d * parseInt(a.wheelStep)) / 100) * c.outerHeight()),
        ...
        function v() {
          ...
          clearTimeout(A);
          l == ~~l
            ? ((k = a.allowPageScroll), B != l && b.trigger("slimscroll", 0 == ~~l ? "top" : "bottom"))
            : (k = !1);
          B = l;
          u >= b.outerHeight()
            ? (k = !0)
            : (c.stop(!0, !0).fadeIn("fast"), a.railVisible && g.stop(!0, !0).fadeIn("fast"));
        }
        function p() {
          a.alwaysVisible ||
        ...
        if (b.parent().hasClass(a.wrapperClass)) {
          ...
          "bottom" === a.start
            ...
            : "top" !== a.start && (m(f(a.start).position().top, null, !0), a.alwaysVisible || c.hide());
          C();
        }
      });
      return this;
